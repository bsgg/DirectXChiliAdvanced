...
public:
	...
	// Operator multiply this matrix by a number or scalator (scalation)
	...
	// Standar multiply by a T type (returns a scaled Matrix)
	_Mat3 operator *(const T rhs) const
	{
		_Mat3 result = *this;
		return result *= rhs;
	}
	// Multiplication by a matrix, returns a matrix
	...
	// Multiplication by a matrix and mutates this matrix
	_Mat3& operator *=(const _Mat3& rhs)
	{
	...
	static _Mat3 Traslation(const _Vec2<T> offset)
	{
